# Zen Library
This documentation is for the stable release of Zen Library.

## Booting the Library
```lua
local ZenLib = loadstring(game:HttpGet(('https://pastebin.com/raw/prt7UBEa')))()
```
...
## Creating a Window
```lua
local Window = ZenLib:MakeWindow({
    Name = "Title of the library", 
    HidePremium = false, 
    SaveConfig = true, 
    ConfigFolder = "ZenTest",
    IntroText = "ZenTest"
})
...
print(ZenLib.Flags["toggle"].Value) -- prints the value of the toggle.
```
